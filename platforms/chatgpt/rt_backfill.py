...
# 补号期间要镜像进任务日志的 logger：协议链路本身，以及接码平台那侧的租号/
# 退款记录 —— 后者关系到钱，出问题时最需要看见。
_MIRRORED_LOGGERS = ("platforms.chatgpt.protocol", "services.sms_service")
